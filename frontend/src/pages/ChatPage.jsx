...
const ChatPage = () => {
  ...
  const handleConversationSearch = async (e) => {
    ...
    try {
      ...
      if (messaginYourself) {
        showToast("Error", "You cannot message your self", "error");
        return;
      }
      ...
      //mock convo is having issue not sure why ..
      ...
      >
        ...
        {!selectedConversation._id && (
          <Flex flex={70} borderRadius={"md"} p={2} flexDir={"column"} alignItems={"center"} justifyContent={"center"} height={"400px"}>
            ...
            <Text fontSize={20}>Select a conversation to start a messaging</Text>
          </Flex>
        )}
