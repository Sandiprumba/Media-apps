import { Avatar, Flex, Image, useColorModeValue, Text, Divider, SkeletonCircle, Skeleton } from "@chakra-ui/react";
...
const MessageContainer = () => {
  ...
  //update the message ... in recoil conversation state
  ...
  return (
    <Flex flex="70" bg={useColorModeValue("gray.200", "gray.dark")} borderRadius={"md"} p={2} flexDirection={"column"}>
      ...
      <Flex flexDir={"column"} gap={4} my={4} px={2} height={"400px"} overflowY={"scroll"}>
        {loadingMessages &&
          [...Array(5)].map((_, i) => (
